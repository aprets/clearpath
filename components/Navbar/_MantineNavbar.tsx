		...
		<>
			<Header height={56}>
				<Container className={classes.inner}>
					...
					<Text>
						<Text sx={(theme) => ({fontSize: 30, fontWeight: 900, color: theme.colors.gray[7]})} component='span'>
							Clear
						</Text>
						<Text sx={(theme) => ({fontSize: 30, fontWeight: 900, color: theme.colors.blue[5]})} component='span'>
							Path
						</Text>
					</Text>
